...
var tb = require("@slicky/templates/builder");
var c = require("@slicky/core/metadata");
            ...
            arg.element.setup.add(b.createCreateDirective(directive.metadata.hash, directive.metadata.type, function (setup) {
                ...
                utils_1.forEach(directive.metadata.inputs, function (input) {
                    ...
                    if (isProperty) {
                        ...
                        setup.setup.add(tb.createWatch(arg.engine.compileExpression(property.value, arg.progress, true), function (watcher) {
                ...
                if (onTemplateDestroy.length) {
                    setup.setup.add(tb.createTemplateOnDestroy(false, function (node) { return node.callback.addList(onTemplateDestroy); }));
                }
